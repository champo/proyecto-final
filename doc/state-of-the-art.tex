...
versión modificada del algoritmo BSAS.% TODO (eordano): Cita
...
los sectores candidatos, y se mantiene el estado de las \textit{bounding box}
(si está en contacto con otra, la velocidad, y la posición). Para resolver
situaciones en la que se esté terminando la colisión, se utilizan datos
correspondientes a la clase de los objetos detectados y la velocidad de cada
jugador previo a la colisión de \textit{bounding boxes}.
