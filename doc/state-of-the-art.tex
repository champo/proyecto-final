...
% TODO: @eordano: no deberia ser un B_F' que se calcula en base a B_F y E'?
% queda confuso sino me pa
% REPLY: Sounds better?
...
% TODO: @eordano no me queda claro para que sirve B_F
% REPLY:
...
jugadores.
% Leaving this as a reminder.(el artículo publicado no entra en detalles acerca de este proceso).
...
% TODO: @eordano esto es una distancia? suena a una regla de actualizacion esto...
% REPLY: yeap. Does this look better?
...
%TODO tebex revisate esta primer oración que quedó medio sucia (más allá de la traduccion)
...
% TODO: @eordano, que hacen con esa P?
% REPLY
...
Este parámetro $P_{t-1,t}$ es una homografia que se calcula tomando una serie de puntos en la imagen y relacionando su posición entre el cuadro $t-1$ y $t$.
