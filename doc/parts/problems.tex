...
puntaje actual, etcétera. Se acotó el problema a la determinación de la
...
conociendo datos como la posición de la pelota. El objetivo inicial del trabajo
era determinar automáticamente posiciones de jugadores fuera de juego, lo cual
...
descripto en \cite{paper-tanos} y se discute en el Capítulo \ref{chap-solucion}
