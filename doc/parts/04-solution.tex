...
previo que detecte e informe a la actualización del contorno qué sectores de
los cuadros del video no corresponden a las siluetas de los objetos de interés
para el seguimiento.
...
funciona aplicando un detector de bordes (se utilizaron tanto el método de
Roberts como el de Canny), umbralizando el resultado, y haciendo un análisis
morfológico de las componentes conexas obtenidas luego de la umbralización.
...
\begin{figure}[H]
  \centering
    ...
    \end{minipage}
    % TODO: Otra screenshot con el algoritmo aplicado
\end{figure}
...
operador morfologico de expansión sobre todos estos puntos.
