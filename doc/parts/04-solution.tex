...
de un dado jugador siempre va a estar contenida en un rectángulo. También se
pueden calcular las dimensiones máximas posibles de ese rectángulo. Se puede
...
%% TODO Champoman: Ni idea como llamarla a la subseccion.
%% Dejo esto para que no te olvides ;)
