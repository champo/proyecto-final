...
\begin{figure}[H]
    \centering
    \begin{tabular}{cccc}
        \subfloat[Cuadro 1]{\includegraphics[width = 1.4in]{./images/cropped_happy_occluded_00001.png}} &
        \subfloat[Cuadro 5]{\includegraphics[width = 1.4in]{./images/cropped_happy_occluded_00005.png}} &
        \subfloat[Cuadro 8]{\includegraphics[width = 1.4in]{./images/cropped_happy_occluded_00008.png}} &
        \subfloat[Cuadro 12]{\includegraphics[width = 1.4in]{./images/cropped_happy_occluded_00012.png}}
    \end{tabular}
...
\begin{figure}[H]
    \centering
    \begin{tabular}{cccc}
        \subfloat[Cuadro 9]{\includegraphics[width = 1.4in]{./images/cropped_boca_00009.png}} &
        \subfloat[Cuadro 12]{\includegraphics[width = 1.4in]{./images/cropped_boca_00012.png}} &
        \subfloat[Cuadro 14]{\includegraphics[width = 1.4in]{./images/cropped_boca_00014.png}} &
        \subfloat[Cuadro 17]{\includegraphics[width = 1.4in]{./images/cropped_boca_00017.png}}
    \end{tabular}
    %% NASTY hack to make refernce work with figures and subfigures, put \label inside \caption env, little bird told me
...
\begin{figure}[H]
    \centering
    \begin{tabular}{cccc}
        \subfloat[Cuadro 1]{\includegraphics[width = 1.4in]{./images/cropped_processing2.png}} &
        \subfloat[Cuadro 5]{\includegraphics[width = 1.4in]{./images/cropped_processing5.png}} &
        \subfloat[Cuadro 8]{\includegraphics[width = 1.4in]{./images/cropped_processing14.png}} &
        \subfloat[Cuadro 12]{\includegraphics[width = 1.4in]{./images/cropped_processing25.png}}
    \end{tabular}
    %% NASTY hack to make refernce work with figures and subfigures, put \label inside \caption env, little bird told me
...
\begin{figure}[H]
    \centering
    \begin{tabular}{cccc}
        \subfloat[Cuadro 2]{\includegraphics[width = 1.4in]{./images/cropped_rendered002.png}} &
        \subfloat[Cuadro 12]{\includegraphics[width = 1.4in]{./images/cropped_rendered007.png}} &
        \subfloat[Cuadro 14]{\includegraphics[width = 1.4in]{./images/cropped_rendered012.png}} &
        \subfloat[Cuadro 17]{\includegraphics[width = 1.4in]{./images/cropped_rendered017.png}}
    \end{tabular}
    %% NASTY hack to make refernce work with figures and subfigures, put \label inside \caption env, little bird told me
