...
\begin{itemize}
  ...
  \item \textbf{Boca vs. Independiente:} El video cuenta con una resolución de
    ...
    el color del césped de la cancha, como se ilustra en las Figuras
...
%% TODO: Eordano acá vamos a describir los videos también? Habría que meter
%% alguna screenshot y chau mepa.

\begin{itemize}
  \item \textbf{Manchester City vs Barcelona:} Del video televisado se extrajeron
    tres escenas en particular. En las Figuras \ref{fig:manchester1} y
    \ref{fig:manchester2} se muestran algunos cuadros de estos fragmentos. El
    video cuenta con una resolución de \textit{720p} (1280 píxeles de ancho por
    720 píxeles de alto). Los jugadores de Manchester City, con su equipo
    deportivo de color blanco, son confundidos por sus características con el
    color de las líneas de la cancha. En el primer recorte, los jugadores son
    correctamente identificados durante los 120 cuadros, exceptuando aquellos
    que atraviezan una línea de cancha. Se corrigen correctamente dos
    oclusiones parciales entre jugadores. En el segundo fragmento, los
    jugadores son correctamente localizados a pesar de la alta velocidad de
    \textit{panning} de la cámara. En el tercer video todos los jugadores, al
    igual que en el primero, son correctamente localizados durante todo el
    video exceptuando aquellos que se intersectan con las líneas marcadas en el
    césped.
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Fragmentos del video televizado de un partido entre los equipos Manchester City y Atlético Barcelona.}
\end{figure}
...
%% TODO EORDANO yo te creo pero aca necesitamos mínimo un screenshot que
%% muestre lo que decis. (CITA TUS FUENTES! ;))
