...
jugadores en la cancha, y corregirá eventuales seguimientos incorrectos. Se desea minimizar
estos errores.
...
Esto puede observarse en la imágenes de las figuras \ref{fig:barsa3} y \ref{fig:barsa4}.
...
\begin{figure}
    ...
    \begin{minipage}{.5\textwidth}
        ...
        \captionof{figure}{En una imagen más cercana, con mayor resolución, sigue siendo
        un caso complicado para la aplicación de contornos activos.}
        \label{fig:barsa2}
    \end{minipage}
    \begin{minipage}{.5\textwidth}
        \centering
        \includegraphics[width=.4\linewidth]{./images/ScreenShot2014-06-11at8-15-38PM.png}
        \captionof{figure}{En la imagen se observa la falta resolución. Los bordes se tornan
        difusos y cuesta diferenciar las características (colores).}
        \label{fig:barsa3}
    \end{minipage}%
    \begin{minipage}{.5\textwidth}
        \centering
        \includegraphics[width=.4\linewidth]{./images/ScreenShot2014-06-11at8-15-52PM.png}
        \captionof{figure}{La imagen muestra varias de las dificultades del problema. La
        falta de resolución, la rapidez de los movimientos y el diminuto tamaño de uno de
        los objetos de intetés: la pelota.}
        \label{fig:barsa4}
    \end{minipage}
\end{figure}
